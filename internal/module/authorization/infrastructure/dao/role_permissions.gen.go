...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.PermissionValue = field.NewString(tableName, "permission_value")
...
func (r *rolePermission) updateTableName(table string) *rolePermission {
	...
	r.PermissionValue = field.NewString(table, "permission_value")
...
func (r *rolePermission) fillFieldMap() {
	...
	r.fieldMap["permission_value"] = r.PermissionValue
}
